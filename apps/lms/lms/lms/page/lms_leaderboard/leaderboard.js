frappe.pages["lms_leaderboard"].on_page_load = (wrapper) => {
...
class Leaderboard {
        ...
        get_leaderboard_config() {
                ...
                frappe
                        .xcall("lms.lms.page.lms_leaderboard.leaderboard.get_leaderboard_config")
                        .then((config) => {
        ...
        render_selected_doctype() {
                this.$sidebar_list.on("click", "li", (e) => {
                        ...
                        frappe.set_route("lms_leaderboard", this.options.selected_doctype);
                        this.make_request();
                });
        }
